...
BOARD_EGL_CFG := device/zte/Tn760/prebuilt/lib/egl/egl.cfg
...
BOARD_CUSTOM_USB_CONTROLLER := ../../device/zte/Tn760/UsbController.cpp
...
TARGET_PREBUILT_KERNEL := device/zte/Tn760/prebuilt/kernel
# recovery
BOARD_USES_RECOVERY_CHINESE := false
TARGET_PREBUILT_RECOVERY_KERNEL := device/zte/Tn760/prebuilt/recovery_kernel
BOARD_CUSTOM_RECOVERY_KEYMAPPING:= ../../device/zte/Tn760/recovery/recovery_ui.c

# Add by ioz9 for update
#TARGET_CUSTOM_RELEASETOOL := device/zte/roamer/tools/roamerupdate
